...
<div class="acadp acadp-listings acadp-list-view">
	<?php if ( $can_show_header ) : ?>
        ...
        <?php if ( $can_show_listings_count || $can_show_orderby_dropdown || $can_show_views_selector ) : ?>
                            ...
                            <div class="btn-group pull-right acadp-xs-clear-float" role="group">
                                <div class="form-group">
                                    <select name="view" class="form-control" onchange="this.form.action=this.value; this.form.submit();">
                                        ...
                                        printf(
                                            '<option value="%s">-- %s --</option>',
                                            esc_url( add_query_arg( 'view', 'list' ) ),
        ...
        while ( $acadp_query->have_posts() ) : 
            ...
            <div <?php the_acadp_listing_entry_class( $post_meta, 'row' ); ?>>
                ...
                <div class="<?php echo esc_attr( $span_middle ); ?>">            
                    ...
                    if ( $can_show_date ) {
                        $info[] = '<time>' . sprintf( esc_html__( 'Posted %s ago', 'advanced-classifieds-and-directory-pro' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ) . '</time>';
                    }
                    ...
                    // categories, locations, views & labels
                    $info = array();					
                    ...
                    <?php do_action( 'acadp_after_listing_content', $post->ID, 'list' ); ?>
                 </div>
