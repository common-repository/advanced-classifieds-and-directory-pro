...
Contributors: pluginsware, freemius
...
[Demo](https://pluginsware.com/demo/) | [Documentation](https://pluginsware.com/documentation/) | [Support](https://pluginsware.com/submit-a-ticket/) | [Premium Version](https://pluginsware.com/pricing/)

https://www.youtube.com/watch?v=0ALU7FqfGAM
...
More information at [PluginsWare](https://pluginsware.com/).
...
That's it! Visit the official [Documentation](https://pluginsware.com/documentation/) page for further setup.

== Frequently Asked Questions ==

= Will the plugin work with my theme? =
"Advanced Classifieds and Directory Pro" has been designed to work with any theme. In case you find any conflict issues, kindly write to us [here](https://pluginsware.com/submit-a-ticket/) explaining the issue along with your site link. You should receive a reply within 24 hours (except Sunday).
...
Yes, the plugin is translation-ready and you can translate it to your own language easily. Kindly follow the instructions [here](https://pluginsware.com/documentation/translate-acadp-plugin/).
...
Kindly write to us [here](https://pluginsware.com/submit-a-ticket/) explaining the issue along with your site link. You should receive a reply within 24 hours (except Sunday).


See our [FAQ](https://pluginsware.com/faq/) page, which is updated more regularly.

== Screenshots ==

1. Listing Detail Page
2. List View
3. All Categories Page
4. Search Widget
5. Others
...
* Tweak: Updated image quality from "medium" and "full" on the modern listings layouts.
* Tweak: Updated Javascript for better performance.
* Tweak: Updated "Google Map" for more accuracy.
* Tweak: Updated "OpenStreetMap" for more accuracy.
* Tweak: Updated Freemius SDK (2.7.4).
* Fix: [+] a few minor bug fixes.

= 3.2.1 =

* Security Fix: Local File Inclusion (Contributor+). Thanks to the security researcher "João Pedro Soares de Alcântara (Kinorth)" and "Darius Sveikauskas" from [Patchstack](https://patchstack.com/).
...
* Security Fix: Fixed "Missing Authorization to Arbitrary Attachment Deletion" issue [reported responsibly](https://plugins360.com/support/) by Adam Goodlin (Wordfence Customer Support Engineer).
...
* Fix: Security Fix. Prevent XSS (Cross-Site Scripting) attempt on the title fields. Thanks to [Softlink ICT, Wilco de Jongh](https://softlink.support) for bringing this issue to us.
* Fix: [+] few minor bug fixes.
...
Introduces several enhancements & bug fixes. [See changelog](https://wordpress.org/plugins/advanced-classifieds-and-directory-pro/#developers)